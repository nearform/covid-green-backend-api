...
async function notices(server, options) {
   ...
   *
   * This endpoint doesn't require any input.
   *
   ...
   *
   * This the last step in the process and will enque the mail for sending.
   *
   ...
   *
   * Responses:
   *  204: The email has been enqued and the unique key invalidated.
