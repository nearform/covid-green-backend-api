...
async function getConfig() {
  ...
  if (isProduction) {
    ...
    config.aws.noticesQueueUrl = await getParameter('self_isolation_notices_url')
    ...
    config.routes.notices = /true/i.test(await getParameter('enable_self_isolation_notices'))
