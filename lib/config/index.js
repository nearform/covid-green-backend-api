...
async function getConfig() {
  const env = envSchema({
    ...
    schema: S.object()
      ...
      .prop('EMAIL_ADDRESS_VERIFY_LIFETIME', S.number())
  })
  ...
  const config = {
    ...
    venues: {
      emailAddressVerifyLifetime: env.EMAIL_ADDRESS_VERIFY_LIFETIME
    }
  }
  ...
  if (isProduction) {
    ...
    config.venues.emailAddressVerifyLifetime = Number(
